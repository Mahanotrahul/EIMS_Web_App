	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<br>
			...
			if(($_SERVER["REQUEST_METHOD"]== "POST") && (isset($_POST['Check_employee_details'])))
			{
				...
				$find_mem = mysqli_query($con, "SELECT SALUTATION, FNAME, LNAME FROM member WHERE ID = ".$_POST['employee_id']."");
				$mem = mysqli_fetch_assoc($find_mem);
				$_SESSION['employee_name'] = $mem['SALUTATION'].' '.$mem['FNAME'].' '.$mem['LNAME'];
			...
			echo '<div class="row">
												...
												<div class="row">
													...
													<div class="col-lg-3 col-md-3">
														...
														<select class="form-control" name="employee_id" id="employee_id" required>
																...
																$emp_details_query = mysqli_query($con, "SELECT FNAME, LNAME, ID, SALUTATION FROM member");
					...
					if(($_SERVER["REQUEST_METHOD"]== "POST") && (isset($_POST['Check_employee_details'])))
					{
						...
						$mem_details_query = mysqli_query($con, "SELECT * FROM member WHERE ID = '".$_POST['employee_id']."'");
