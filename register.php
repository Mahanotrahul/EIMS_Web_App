		...
		if(mysqli_query($con, $query))
		{
			...
			$newfile_name = $target_dir.strtolower("$f");
				...
				if((filesize($_FILES['userfile']["tmp_name"])/1024) > 1024)
				{
					...
					echo "<script type='application/javascript'>alert('File Size is Too Big. Please try again');window.location = 'register';</script>";
			...
			echo "<script type='application/javascript'>alert('Registered Succesfully');window.location = 'login';</script>";
		}
		else
		{
                	...
                	<div class="panel-body">
                    	...
                    	<div class="row">
												<div class="col-lg-4 col-md-4">
														<label class="label control-label">Salutation</label>
														<select class="form-control" name="salutation" style="height:45px;" value="<?php if(isset($_SESSION['salutation'])){ echo $_SESSION['salutation'];}?>" required>
