...
echo '<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
  ...
  <ul class="nav menu">
    ...
    <li id="profile"><a href="profile"><em class="fa fa-tags">&nbsp;</em> Profile</a></li>
    ...
    echo '<li id="request_leave"><a href="request_leave"><em class="fa fa-tag">&nbsp;</em> Request for Leave</a></li>
